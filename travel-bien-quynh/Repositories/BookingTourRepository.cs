...
{
    public class BookingTourRepository : BaseRepository<BookingTour>, IBookingTourRepository
    {
        public BookingTourRepository(IMongoDbContext mongoContext) : base(mongoContext)
        {
